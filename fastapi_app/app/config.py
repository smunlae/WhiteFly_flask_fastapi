...
class Settings:
    secret_key = os.getenv("SECRET_KEY", "kjsdnfujondosafcnosdin43247")
    ...
    base_path = os.getenv("BASE_PATH", "/fastapi")
    ...
    fpjs_server_api_base_url = os.getenv("FPJS_SERVER_API_BASE_URL", "https://eu.fpjs.io")
